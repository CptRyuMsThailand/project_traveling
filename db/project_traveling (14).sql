...
--
-- Host: 127.0.0.1
-- Generation Time: Feb 18, 2023 at 09:14 AM
...
(22, 'Node ทดลอง Bts สายลวด', 'Node ทดสอบที่ปากน้ำ', '2023-02-14', '2023-04-05', './images/1676386715.png', 5, 1),
(23, 'Node ทดลอง Bts วัดพระศรี', 'Node ทดลองที่ ทดสอบเมื่ออยู่ที่มหาวิทยาลัย', '2023-02-14', '2023-04-05', './images/1676388302.png', 6, 1);
...
(5, 'BTS สายลวด (E22)', '13.57751343071331900000000000000', '100.60521250456937000000000000000', 1, '', 1),
(6, 'BTS วัดพระศรีมหาธาตุ (N17)', '13.87534949547723400000000000000', '100.59680479463012000000000000000', 6, '', 1);
...
--
ALTER TABLE `table_event`
  MODIFY `ev_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=24;

--
-- AUTO_INCREMENT for table `table_file`
--
ALTER TABLE `table_file`
  MODIFY `file_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=21;
