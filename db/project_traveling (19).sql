...
--
-- Host: 127.0.0.1
-- Generation Time: Feb 26, 2023 at 11:20 AM
...
(8, 'วัดสาขลา', '13.54537886218486700000000000000', '100.50042016057150000000000000000', 7, '', 1);
...
--
ALTER TABLE `table_event`
  MODIFY `ev_id` int(11) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=27;
...
--
ALTER TABLE `table_viewpoint`
  MODIFY `vp_id` bigint(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=18;
COMMIT;
