...
--
-- Host: 127.0.0.1
-- Generation Time: Feb 19, 2023 at 10:35 AM
...
(24, 'มาฆบูชา', '\'\'\'\'', '2023-03-06', '2023-03-06', 15, 3, 15, 3, 'moon', './images/1676798385.png', 1, 1);
...
(7, 'dc', './images/1676711216.jpg', 16),
(10, 'MM', './images/1676711216.jpg', 16);
...
--
ALTER TABLE `table_hotel`
  MODIFY `ht_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
...
--
ALTER TABLE `table_viewpoint`
  MODIFY `vp_id` bigint(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=13;
COMMIT;
