...
if(isset($_POST["form_post"])){
	...
	$stmt = $conn->prepare("INSERT INTO table_event(ev_name,ev_date_beg,ev_date_end,ev_day_beg,ev_month_beg,ev_day_end,ev_month_end,ev_day_type,ev_img_list,ev_desc,ev_origin,ev_ref_place_id) VALUES (?,?,?,?,?,?,?,?,?,?,?,?)");

	$stmt->bind_param("ssssssssssii",$_POST["form_name"],$date_start,$date_end,$form_day_beg,$form_month_beg,$form_day_end,$form_month_end,$calendar_type,$_POST["form_image"],$_POST["form_desc_value"],getUserInfo($conn)["us_id"],$_POST["form_place_id"]);
	...
	<div class="w3-row-padding">
		...
		<div class="w3-half w3-padding ">
			...
			<label class="w3-label"> Month
				<input type="number" name="form_month_beg" class="w3-input w3-border">
			</label>
			</div>
		</div>
		<div class="w3-half w3-padding">
			...
			<label class="w3-label"> Month
				<input type="number" name="form_month_end" class="w3-input w3-border">
			</label>
		</div>
		</div>
		<div class="w3-full w3-padding">
